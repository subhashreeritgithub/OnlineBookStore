...
<body>
    ...
    <div class="container-fluid">
        ...
        include 'dbconnection.php';
          ...
          $query = "SELECT * FROM `comics_books` WHERE `b_id`= '$dis_book_id'";
        ...
        ?>
           <!-- card start -->
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                <p><span class="text-danger fs-5 fw-bold"> Book Name : <?php echo $row['book_name'] ?> | </span> <span class="fw-bold">Released : <?php echo $row['released_date'] ?></span></p>
