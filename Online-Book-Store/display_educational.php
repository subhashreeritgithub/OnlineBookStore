...
<body>
    ...
    <div class="container-fluid">
        ...
        include 'dbconnection.php';
          ...
          $query = "SELECT * FROM `educational_books` WHERE `b_id`= '$dis_book_id'";
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="p-4 border">
                        <img src="<?php echo "Admin-Pannel/Book-Images/".$row['book_image'] ?>" class="img-fluid shadow" alt="..."    height="300px" width="300px">
                    </div>
                    </div>
                </div>
                <div class="col-md-8">
