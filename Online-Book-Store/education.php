...
<body>
  <!-- Image slider start -->
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <img src="Background-Images/education1.jpg" class="d-block w-100" alt="..." height="750px">
            </div>
            <div class="carousel-item" data-bs-interval="1000">
            <img src="Background-Images/education2.jpg" class="d-block w-100" alt="..." height="750px">
            </div>
            <div class="carousel-item" data-bs-interval="1000">
            <img src="Background-Images/education3.jpg" class="d-block w-100" alt="..." height="750px">
            </div>
            <div class="carousel-item" data-bs-interval="1000">
            <img src="Background-Images/education4.jpg" class="d-block w-100" alt="..." height="750px">
            </div>
            <div class="carousel-item" data-bs-interval="2000">
            <img src="Background-Images/education5.jpg" class="d-block w-100" alt="..." height="750px">
            </div>
        </div>
  ...
  <!-- Image slider end -->
  <hr>
  <h1 class="fw-bold text-primary text-center">All Types Educational Books</h1>
  <!-- Card start -->
