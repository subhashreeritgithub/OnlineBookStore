...
<html lang="en">
  <head>
    ...
    <title>Update Sports Books</title>
            ...
            <div class="education-book-form mt-5 mb-5">
                ...
                <div class="card">
                    <h2 class="card-header text-center fw-bold bg-primary text-light">
                        <i class="fa-solid fa-plus"></i> Update Sports Books
                    </h2>
                </div>
                <?php
                ...
                $query = "SELECT * FROM sports_books WHERE b_id = '$u_id'";
                ...
                <form action="update_config.php" method="POST" class="shadow border border-primary rounded p-5" novalidate enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-primary btn-lg" name="sports_update">Update Book</button>
                        </div>
                    </div>
                </form>
                <?php } } ?>
