...
<html lang="en">
  <head>
    ...
    <title>Update Educational Books</title>
            ...
            <div class="education-book-form mt-5 mb-5">
                ...
                <div class="card">
                    <h2 class="card-header text-center fw-bold bg-primary text-light">
                        <i class="fa-solid fa-plus"></i> Update Educational Books
                    </h2>
                </div>
                <?php
                ...
                $query = "SELECT * FROM educational_books WHERE b_id = '$u_id'";
                ...
                <form action="update_config.php" method="POST" class="shadow border border-primary rounded p-5" novalidate enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="publisher" class="fs-5"><?php echo $row['book_image']; ?></label>
                            <input type="file" class="form-control" name="book_image" value="<?php echo $row['book_image']; ?>" id="publisher">
                            <img src="<?php echo "Book-Images/".$row['book_image']; ?>" alt="" height="100px" width="100px">
                            <input type="hidden" name="old_image" value="<?php echo $row['book_image']; ?>">
                
                        </div>

                        <div class="d-grid">
                            <button class="btn btn-primary btn-lg" name="educational_update">Update Book</button>
                        </div>
                    </div>
                </form>
                <?php } } ?>
