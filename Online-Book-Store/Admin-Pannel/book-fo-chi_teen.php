...
<html lang="en">
  <head>
    ...
    <title>Childrens and Teens</title>
            ...
            <div class="education-book-form mt-5 mb-5">
                ...
                <div class="card">
                    <h2 class="card-header text-center fw-bold bg-primary text-light">
                        <i class="fa-solid fa-plus"></i> Add Sports Books
                    </h2>
                </div>
                <form action="" method="POST" class="needs-validation shadow border border-primary rounded p-5" novalidate enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg" name="submit_sports">Add Book</button>
                        </div>
                    </div>
                </form>
            </div>
