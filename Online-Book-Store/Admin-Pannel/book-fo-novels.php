            ...
            <div class="education-book-form mt-5 mb-5">
                ...
                <div class="card">
                    <h2 class="card-header text-center fw-bold bg-primary text-light">
                        <i class="fa-solid fa-plus"></i> Add Novels Books
                    </h2>
                </div>
                <form action="" method="POST" class="needs-validation shadow border border-primary rounded p-5" novalidate enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="date" class="form-control" id="post_date" value="<?php echo $release_date; ?>" name="release_date" required>
                            <div class="invalid-feedback fw-bold">
                            !!.....This field is required.....!!
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="number" class="form-control" id="post_date" value="<?php echo $book_price; ?>" name="book_price" placeholder="Enter the price of the book....." required>
                            <div class="invalid-feedback fw-bold">
                            !!.....This field is required.....!!
                            </div>
                            <span class="text-danger fw-bold">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="publisher" value="<?php echo $publisher_name; ?>" name="publisher_name" placeholder="Enter the publisher of the book....." required>
                            <div class="invalid-feedback fw-bold">
                            !!.....This field is required.....!!
                            </div>
                            <span class="text-danger fw-bold">
                        ...
                        <div class="d-grid">
                            <button type="submit" name="submit_novels" class="btn btn-primary btn-lg">Add Book</button>
                        </div>
                    </div>
                </form>
            </div>
