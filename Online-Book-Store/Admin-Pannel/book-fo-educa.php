            ...
            <div class="education-book-form mt-5 mb-5">
                ...
                <div class="card">
                    <h2 class="card-header text-center fw-bold bg-primary text-light">
                        <i class="fa-solid fa-plus"></i> Add Educational Books
                    </h2>
                </div>
                <form action="" method="POST" class="needs-validation shadow border border-primary rounded p-5" novalidate enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="book_name" id="book_name" value="<?php echo $book_name; ?>" placeholder="Enter the name of the book....." required>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="author_name" id="author_name" value="<?php echo $author_name; ?>" placeholder="Enter the name of the author....." required>
                            <div class="invalid-feedback fw-bold">
                            !!.....This field is required.....!!
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="date" class="form-control" name="release_date"  id="post_date" value="<?php echo $release_date; ?>" required>
                            <div class="invalid-feedback fw-bold">
                            !!.....This field is required.....!!
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="publisher" class="fs-5">Book Image</label>
                            <input type="file" class="form-control" name="book_image" id="publisher" required>
                            <div class="invalid-feedback fw-bold">
                            !!.....This field is required.....!!
                            </div>
                            <span class="fw-bold text-danger">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-primary btn-lg" name="educational_submit">Add Book</button>
                        </div>
                    </div>
                </form>
            </div>
