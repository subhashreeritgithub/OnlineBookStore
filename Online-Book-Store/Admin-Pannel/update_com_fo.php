    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="education-book-form mt-5 mb-5">
                ...
                $query = "SELECT * FROM comics_books WHERE b_id = '$u_id'";
                ...
                <form action="update_config.php" method="POST" class="shadow border border-primary rounded p-5" novalidate enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="date" class="form-control" name="released_date" value="<?php echo $row['released_date']; ?>"  id="post_date">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-primary btn-lg" name="comic_update">Update Book</button>
                        </div>
                    </div>
                </form>
                <?php } } ?>
